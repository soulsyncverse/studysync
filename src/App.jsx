...
return () => {active=false;unsub();};
  ...
  return(<div style={{minHeight:"100vh",background:t.bg,fontFamily:"'DM Sans','Segoe UI',sans-serif",color:t.text,transition:"background .3s"}}>
    ...
    {/* Nav */}
    <div className="ss-bottom-nav" style={{position:"fixed",bottom:8,left:8,right:8,background:t.nav,backdropFilter:"blur(20px)",border:`1px solid ${t.border}`,borderRadius:18,zIndex:100,padding:"7px 0 10px"}}>
      {/* Pro row */}
