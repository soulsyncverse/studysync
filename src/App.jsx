...
return () => {active=false;unsub();};
  ...
  return(<div style={{position:"relative",height:"100dvh",minHeight:"100vh",background:"yellow",fontFamily:"'DM Sans','Segoe UI',sans-serif",color:t.text,transition:"background .3s"}}>
    ...
    {/* Nav */}
    <div className="ss-bottom-nav" style={{position:"absolute",bottom:0,left:8,right:8,background:"red",backdropFilter:"blur(20px)",border:`1px solid ${t.border}`,borderRadius:18,zIndex:100,padding:"7px 0 10px"}}>
      {/* Pro row */}
